...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  1 11:01:41 2022
...
def main(raw_dir,
    ...
    def df_sanitizer_fun(df, lazy=False):
        ...
        df = dd.concat([df.iloc[:,0], df.iloc[:,1].str.split(',', expand=True, n = 9)] ,axis=1, ignore_unknown_divisions=True)
