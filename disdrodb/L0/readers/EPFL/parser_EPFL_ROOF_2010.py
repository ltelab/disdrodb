...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun  2 03:15:11 2022
...
def main(raw_dir,
    ...
    def df_sanitizer_fun(df, lazy=False):
        ...
        # Drop Debug_data
        df = df.drop(columns=["id", "datalogger_temperature", "datalogger_voltage", "Debug_data", "datalogger_error"])

        # If raw_drop_concentration or raw_drop_average_velocity raw_drop_number is nan, drop the row
