...
######################################
raw_dir = "/home/kimbo/data/Campagne/Raw/MELBURNE"
processed_dir = "/home/kimbo/data/Campagne/Processed/MELBURNE"
...
df = df[0].str.split(';', n=80, expand=True)
...
# Remove last 5 column
df['raw_drop_number'] = df['raw_drop_number'].str.rsplit(';', n=6, expand=True)[0]

# Add ; to end of raw_drop_number
df['raw_drop_number'] = df['raw_drop_number'] + ';'

# Merge time
# df1['time'] = df1[['date_sensor', 'time_sensor']].agg(' '.join, axis=1)
# df1['time'] = df1['date_sensor'].astype(str) + df1['time_sensor']
