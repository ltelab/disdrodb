...
processed_dir = "/home/kimbo/data/Campagne/DISDRODB/Processed/NCAR/RELAMPAGO/SAO_BORJA_OTT"
force = False 
force = True
lazy = True 
lazy = False
...
col_to_drop = ['sensor_temperature_trasmitter', 'sensor_temperature_pcb', 'rainfall_rate_16_bit_1200', 'sensor_temperature_receiver', 'snowfall_rate', 'rain_kinetic_energy', 'rainfall_rate_16_bit_30']
df = df.drop(columns=col_to_drop)
