...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 17 10:52:02 2022
...
######################################
raw_dir = "/home/kimbo/data/Campagne/DISDRODB/Raw/NCAR/SNOWIE/CU_SNOW_BANK"
processed_dir = "/home/kimbo/data/Campagne/DISDRODB/Processed/NCAR/SNOWIE/CU_SNOW_BANK"
force = False 
force = True
lazy = True 
lazy = False
...
# Drop invalids rows
df = df[df['temp'].str[0:2].str.isnumeric()]
# df1 = pd.to_numeric(df['temp'].str[1], errors='coerce')
# df = df[~df['temp'].str.contains('TYP OP4A')][:-1]


# Reshape dataframe
a = df.to_numpy()
a = a.reshape(int(len(a)/39),39)
df = pd.DataFrame(a)
