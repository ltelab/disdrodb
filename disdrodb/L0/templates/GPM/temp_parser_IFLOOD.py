...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 31 13:12:40 2022
...
######################################
raw_dir = "/SharedVM/Campagne/GPM/raw/IFLOOD"
processed_dir = "/SharedVM/Campagne/GPM/processed/IFLOOD"
...
all_stations_files = sorted(
    glob.glob(os.path.join(raw_dir, "data", "*/*.zip"), recursive=True)
)
...
def df_sanitizer_fun(df, lazy=False):
    ...
    df = dd.concat(
        [df.iloc[:, 0], df.iloc[:, 1].str.split(",", expand=True, n=9)], axis=1
    )
