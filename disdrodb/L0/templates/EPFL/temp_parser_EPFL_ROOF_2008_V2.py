...
######################################
raw_dir = "/SharedVM/Campagne/ltnas3/Raw/EPFL_ROOF_2008/EPFL_ROOF_2008_V2"
processed_dir = "/SharedVM/Campagne/ltnas3/Processed/EPFL_ROOF_2008/EPFL_ROOF_2008_V2"
...
all_stations_files = sorted(
    glob.glob(os.path.join(raw_dir, "data", "*/*.dat*"), recursive=True)
)
