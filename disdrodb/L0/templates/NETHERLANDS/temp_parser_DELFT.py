...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 14 10:15:11 2022
...
glob_pattern = os.path.join("data", station_id, "*.tar.xz*")  # CUSTOMIZE THIS
...
get_OTT_Parsivel_dict()  # Wrong dependency, to be changed
get_OTT_Parsivel2_dict()  # Wrong dependency, to be changed
