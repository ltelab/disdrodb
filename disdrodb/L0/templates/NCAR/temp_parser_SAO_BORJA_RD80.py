...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 10 11:32:24 2022
...
######################################
raw_dir = "/home/kimbo/data/Campagne/DISDRODB/Raw/NCAR/RELAMPAGO/SAO_BORJA_RD80"
processed_dir = "/home/kimbo/data/Campagne/DISDRODB/Processed/NCAR/RELAMPAGO/SAO_BORJA_RD80"
force = False 
force = True
lazy = True 
lazy = False
...
def df_sanitizer_fun(df, lazy=False):
    ...
    for c in col_raw:
        df['raw_drop_concentration'] += df[c].astype(str) + ';'
