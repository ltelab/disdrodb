...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 18 06:50:20 2022
...
######################################
raw_dir = "/home/kimbo/data/Campagne/DISDRODB/Raw/NCAR/VORTEX2/VORTEX2_2010"
processed_dir = "/home/kimbo/data/Campagne/DISDRODB/Processed/NCAR/VORTEX2/VORTEX2_2010"
force = False 
force = True
lazy = True 
lazy = False
...
# Cast time
df["time"] = pd.to_datetime(df["sensor_date"] + '-' + df["sensor_time"], format="%d.%m.%Y-%H:%M:%S")
...
try:
    ...
    # Not present, so ignore (not all station have the same format)
    col_to_drop = ['sample_interval']
    df = df.drop(columns=col_to_drop)
    pass
...
if df['raw_drop_number'].str.contains('NaN').any():
