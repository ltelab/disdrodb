...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  2 09:55:09 2022
...
######################################
raw_dir = "/home/kimbo/data/Campagne/DISDRODB/Raw/NCAR/PECAN/MP2_UAH_MIPS"
processed_dir = "/home/kimbo/data/Campagne/DISDRODB/Processed/NCAR/PECAN/MP2_UAH_MIPS"
force = False
force = True
lazy = True
lazy = False
...
df = df.drop(
    columns=["Unknow_TO_DROP", "Day", "Month", "Year", "Hour_minute", "Second"]
)
...
file_list = "/home/kimbo/data/Campagne/DISDRODB/Raw/NCAR/PECAN/MP2_UAH_MIPS/data/11/mips_20150617_dsd.dat"
