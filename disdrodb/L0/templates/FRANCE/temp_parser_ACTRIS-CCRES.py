...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 13 08:27:38 2022
...
from disdrodb.L0.standards import get_sensor_variables

##------------------------------------------------------------------------.
######################################
#### 1. Define campaign filepaths ####
######################################
raw_dir = "/home/kimbo/data/Campagne/DISDRODB/Raw/FRANCE/ACTRIS-CCRES"  # Must end with campaign_name upper case
processed_dir = "/home/kimbo/data/Campagne/DISDRODB/Processed/FRANCE/ACTRIS-CCRES"  # Must end with campaign_name upper case
force = False
force = True
lazy = True
lazy = False
