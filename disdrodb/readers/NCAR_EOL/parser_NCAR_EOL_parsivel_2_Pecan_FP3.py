...
if __name__ == '__main__':
    # main()
    main(raw_dir = '/home/kimbo/data/Campagne/DISDRODB/Raw/NCAR/PECAN/FP3_NCAR_EOL_PARSIVEL_DISDROMETER_DATA',
             processed_dir = '/home/kimbo/data/Campagne/DISDRODB/Processed/NCAR/PECAN/FP3_NCAR_EOL_PARSIVEL_DISDROMETER_DATA',
             l0a_processing=True,
             l0b_processing=True,
             keep_l0a=True,
             force=True,
