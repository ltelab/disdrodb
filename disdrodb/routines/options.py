...
from disdrodb.api.checks import check_sensor_name, check_product, check_temporal_resolution
...
from disdrodb.utils.time import get_sampling_information, ensure_timedelta_seconds
...
class L1ProcessingOptions:
    ...
    def __init__(self, filepaths, parallel, sensor_name, temporal_resolutions=None):
        ...
        src_dict_product_options = {
            temporal_resolution: get_product_options(product=product,
