...
# metadata_fpaths = glob.glob(os.path.join(ARCHIVE_DIR, "*/*/metadata/*.yml")) # FUTURE CORRECT STRUCTURE
...
def get_data_source_from_metadata_yml(fpath): 
    data_source = os.path.basename(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(fpath))))) # TODO REMOVE
    # data_source = os.path.basename(os.path.dirname(os.path.dirname(os.path.dirname(fpath)))) # TODO USE
    return data_source 
