...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 25 14:40:08 2022
...
######################################
raw_dir = "/SharedVM/Campagne/GPM/raw/MC3E"
processed_dir = "/SharedVM/Campagne/GPM/processed/MC3E"
...
import tarfile
tar = tarfile.open(all_stations_files[0])
...
df = dd.read_csv(tar.extractfile(file), compression='infer', header=0, sep=' ', error_bad_lines=False)
