...
fpath1 = "/ltenas3/0_Data/DISDRODB/Raw/ARM/AWARE/data/awrldM1/awrldM1.b1.20151119.023600.cdf"
fpath = "/ltenas3/0_Data/DISDRODB/Raw/ARM/CACTI/data/corldM1/corldM1.b1.20180923.193000.cdf"
...
# FULL CHECK
campaigns = ["ACE_ENA", "AWARE", "CACTI", "COMBLE", "GOAMAZON", "MARCUS",
             "MICRE", "MOSAIC", "SAIL", "SGP", "TRACER"]
...
list_station_file_example = [glob.glob(os.path.join(d, "*.cdf"))[0] for d in list_stations_fpaths]
...
ds_tmp = xr.open_dataset("/ltenas3/0_Data/DISDRODB/Raw/ARM/SAIL/data/gucldS2/gucldS2.b1.20210903.100500.cdf")
