...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb  1 12:39:35 2022
...
######################################
raw_dir = "/SharedVM/Campagne/GPM/raw/LPVEX"
processed_dir = "/SharedVM/Campagne/GPM/processed/LPVEX"
...
for f in all_stations_files[:]:
    ...
    df_temp = pd.read_csv(tar.extractfile(path), compression='infer', header=None, sep='   ', error_bad_lines=False, names=column_names)
